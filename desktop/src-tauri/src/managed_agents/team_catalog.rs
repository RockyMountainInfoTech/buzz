...
/// head shared indefinitely — the A3/I3 failure mode. Splitting the shared
/// logic here also avoids a cross-module layering violation.
pub fn tombstone_team_catalog_coordinate(
    ...
    // Single transaction (see the crash invariant above).
